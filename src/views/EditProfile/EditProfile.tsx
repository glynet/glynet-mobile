        ...
        <AppContainer headerTitle={"Profili Düzenleyici"} hideTabs={true} navigation={navigation}>
                    ...
                    <View style={styles.profile_content}>
                        ...
                        <View style={styles.profile_metrics_container}>
                            <Text style={styles.profile_metric}>
                                <Text style={styles.profile_metric_value}>89k</Text> takipçi
                            </Text>
                            <Text>・</Text>
                            <Text style={styles.profile_metric}>
                                <Text style={styles.profile_metric_value}>101</Text> takip
                            </Text>
                        </View>
            ...
            <View style={styles.profile_inputs_container}>
                ...
                >
                    ...
                    <TextInput value={name} onChangeText={(newName) => setName(newName)} placeholder={"İsim"} style={styles.profile_input} maxLength={24} />
                </View>
                <View style={styles.profile_input_container}>
                    <Text style={styles.profile_input_title}>Kullanıcı Adı</Text>
                    <TextInput value={username} onChangeText={(newUsername) => setUsername(newUsername)} placeholder={"Kullanıcı Adı"} style={styles.profile_input} maxLength={24} />
                </View>
                <View style={styles.profile_input_container}>
                    <Text style={styles.profile_input_title}>Hakkında</Text>
                    <TextInput value={about} onChangeText={(newData) => setAbout(newData)} placeholder={"Hakkında"} style={styles.profile_input} maxLength={128} />
                </View>
                <View style={styles.profile_input_container}>
                    <Text style={styles.profile_input_title}>İnternet Sitesi</Text>
                    <TextInput value={website} onChangeText={(newData) => setWebsite(newData)} placeholder={"İnternet Sitesi"} style={styles.profile_input} maxLength={64} />
                </View>
                ...
                >
                    <TouchableOpacity style={[styles.profile_button, styles.profile_button_with_text, { width: "100%" }]} activeOpacity={0.8} onPress={() => setFollow(!isFollowing)}>
                        <PencilIcon style={styles.profile_button.icon} />
