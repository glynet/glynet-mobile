...
import { BookmarkFilledIcon, BookmarkOutlineIcon, CommentIcon, HeartFilledIcon, HeartOutlineIcon, VerifiedIcon, VerticalIcon } from "../../../utils/icons"
        ...
        <View style={styles.post}>
                    ...
                    <View style={styles.post_author_details}>
                        <View style={styles.post_author_name}>
                            <Text
                                ...
                                style={styles.post_author_name_text}
                            >
                                {content.author.name}
                            </Text>
                        ...
                        {content.content.location !== "" && (
                            <Text style={styles.post_author_date}>
                                <Text
                                    onPress={() =>
                                    ...
                                    style={styles.post_author_location}
                                >
                                    {content.content.location}
                                </Text>{" "}
                                ─ {moment.unix(content.content.timestamp).fromNow()}
                            </Text>
                        )}
            ...
            {content.content.text !== "" && (
                <View style={styles.post_text_container}>
                    <TextView style={styles.post_text} mentionHashtagPress={mentionHashtagClick} mentionHashtagColor={theme.THEME_COLOR}>
                        {content.content.text}
                    </TextView>
                </View>
            )}

            {content.content.attachments.length !== 0 && content.content.attachments[0].type === "image" && (
                <View style={styles.post_content_container}>
                    <Image
                        source={{
                            uri: `${global.CDN_URL}/${content.content.attachments[0].url}`,
                        }}
                        style={[
                            styles.post_content,
                            {
                                width: Dimensions.get("window").width,
                                height: Dimensions.get("window").width * (content.content.attachments[0].height / content.content.attachments[0].width),
                            },
                        ]}
                    />
                </View>
            ...
            <View style={styles.post_buttons_container}>
                ...
                <TouchableOpacity
                    ...
                    style={{
                        ...styles.post_button,
                        ...styles.post_button_padding,
                    }}
                    onPress={() => {
                        navigation.navigate("Comments", {
                            post_id: "1024387206380429312",
                            is_reply: false,
                        })
                    }}
                >
